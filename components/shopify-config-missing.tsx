  ...
  return (
    <main className="min-h-screen pt-28 pb-16 px-4">
      <div className="mx-auto max-w-xl rounded-3xl border border-border bg-card p-8 text-center shadow-sm">
        <h1 className="font-heading text-2xl font-bold text-primary mb-3">Store not connected</h1>
        <p className="text-muted-foreground mb-4">
          ...
          <strong className="font-medium text-foreground">private</strong> Storefront token from your store
